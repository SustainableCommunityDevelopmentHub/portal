...
class Books(APIView):
    ...
    def create_advanced_filters(self, field, terms):
        fields = {'adv_contributor': ['_grp_contributor', '_grp_contributor.folded', '_grp_contributor.stemmed'],
        ...
        field_term = fields.get(field, ['dublin_core.' + field + '.value', 'dublin_core.' + field + '.value.folded', 'dublin_core.' + field + '.value.stemmed'])
