  ...
  function Router($stateProvider, $urlRouterProvider, $locationProvider, config){
    ...
    // abstract state used to load other search states
      ...
      .state('searchResults', {
        ...
        resolve: {
          searchResults: ['$rootScope', '$stateParams', 'SearchService', 'DataService', 'SORT_MODES', 'ADVANCED_SEARCH', function($rootScope, $stateParams, SearchService, DataService, SORT_MODES, ADVANCED_SEARCH){
      ...
      .state('books', {
        ...
        resolve: {
          book: ['$stateParams', function($stateParams) {
      ...
      .state('contributors', {
        ...
        resolve: {
          contributors: ['$rootScope', 'DataService', function($rootScope, DataService){
      ...
      .state('faq', {
        ...
        resolve: {
          spinner: ['$rootScope', function($rootScope) {
            $rootScope.showSpinner = false;
          }]
        }
      })
      ...
      .state('savedRecords', {
        ...
        resolve: {
          records: ['$q', 'SavedRecordsService', function($q, SavedRecordsService) {
            return $q.when(SavedRecordsService.getRecords()).then(function(records) {
              return records;
            });
          }],
          searches: ['$q', 'SavedRecordsService', function($q, SavedRecordsService) {
